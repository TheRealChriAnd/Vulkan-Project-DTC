...
protected:
	void transitionImageLayout(bool transfer, VkImage image, uint32_t src, uint32_t dst, uint32_t layerCount = 1);
	void transitionImageLayout2(bool transfer, VkImage image, uint32_t src, uint32_t dst, uint32_t layerCount = 1);
