...
void Texture2D::transitionImageLayout(DeviceVK * device, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
...
void Texture2D::copyBufferToImage(DeviceVK * device, const BufferVK & buffer, uint32_t width, uint32_t height)
{
	CommandBufferVK commandBuffer(device);
	commandBuffer.begin();
